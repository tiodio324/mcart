...
<div class="container">
    <div class="row gy-4">
        ...
        <div class="col-lg-4">
            <article>
                <div class="post-img">
                    <img src="<?echo DEFAULT_TEMPLATE_PATH?>/assets/img/articles/blog-1.jpg" alt="" class="img-fluid">
                </div>
        ...
        <div class="col-lg-4">
            <article>
                <div class="post-img">
                    <img src="<?echo DEFAULT_TEMPLATE_PATH?>/assets/img/articles/blog-2.jpg" alt="" class="img-fluid">
                </div>
        ...
        <div class="col-lg-4">
            <article>
                <div class="post-img">
                    <img src="<?echo DEFAULT_TEMPLATE_PATH?>/assets/img/articles/blog-3.jpg" alt="" class="img-fluid">
                </div>
        ...
        <div class="col-lg-4">
            <article>
                <div class="post-img">
                    <img src="<?echo DEFAULT_TEMPLATE_PATH?>/assets/img/articles/blog-4.jpg" alt="" class="img-fluid">
                </div>
        ...
        <div class="col-lg-4">
            <article>
                <div class="post-img">
                    <img src="<?echo DEFAULT_TEMPLATE_PATH?>/assets/img/articles/blog-5.jpg" alt="" class="img-fluid">
                </div>
        ...
        <div class="col-lg-4">
            <article>
                <div class="post-img">
                    <img src="<?echo DEFAULT_TEMPLATE_PATH?>/assets/img/articles/blog-6.jpg" alt="" class="img-fluid">
                </div>
