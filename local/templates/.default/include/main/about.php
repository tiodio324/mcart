<!-- About Section --> <section id="about" class="about section light-background">
<div class="container">
	<div class="row gy-4">
		<div class="col-lg-6 position-relative align-self-start">
 <img src="<?echo DEFAULT_TEMPLATE_PATH?>/assets/img/about.jpg" class="img-fluid" alt="">
		</div>
		<div class="col-lg-6 content">
			...
			<ul>
				<li><i class="bi bi-check2-all"></i> Мы используем технологии, которые позволяют значительно снизить энергопотребление.</li>
				<li><i class="bi bi-check2-all"></i> Наши решения обеспечивают стабильную работу оборудования даже в самых сложных условиях.</li>
				<li><i class="bi bi-check2-all"></i> Мы адаптируем наши решения под конкретные нужды вашего предприятия.</li>
			</ul>
			<p>
